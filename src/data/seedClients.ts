...
export const seedClients: Client[] = [
  // essa função é responsável por criar uma lista de clientes de exemplo para ser usada como dados iniciais no aplicativo. Cada cliente tem um ID único, nome, empresa, email, telefone, notas e data de criação.
