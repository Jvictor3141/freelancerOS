...
export function DashboardMetricCard({
  ...
  return (
    <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm shadow-slate-100">
      ...
      <p className="mt-3 text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold tracking-tight text-slate-950">
        {value}
      </p>
      <p className="mt-1 text-sm max-[374px]:text-xs text-slate-500">{description}</p>
    </div>
  )
}
