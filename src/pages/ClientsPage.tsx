...
export function ClientsPage() {
  ...
  // O submit espera o banco responder antes de fechar o modal e atualizar a UI.
  async function handleClientSubmit(values: ClientInput) {
    ...
    try {
      ...
      alert(
        getErrorMessage(submitError, 'Nao foi possivel salvar o cliente.'),
      );
    } finally {
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">
              Aqui comeca a parte seria do produto. Sem cliente
