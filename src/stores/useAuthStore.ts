...
export const authStoreSelectors = {
  ...
  initialized: (state: AuthStoreState) => state.initialized,
  authFlow: (state: AuthStoreState) => state.authFlow,
  loading: (state: AuthStoreState) => state.loading,
  error: (state: AuthStoreState) => state.error,
  notice: (state: AuthStoreState) => state.notice,
  isAuthenticated: (state: AuthStoreState) => Boolean(state.user),
}
